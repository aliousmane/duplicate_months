...
runfile('D:/HadISD_v3/project/station_selection.py', wdir='D:/HadISD_v3/project')
runfile('D:/HadISD_v3/project/get_isd_files.py', wdir='D:/HadISD_v3/project')
runfile('D:/HadISD_v3/project/mk_netcdf_files.py', wdir='D:/HadISD_v3/project')
"""
...
runfile('D:/HadISD_v3/project/internal_checks.py', wdir='D:/HadISD_v3/project')
#run neighbour_checks.py --masking
runfile('D:/HadISD_v3/project/neighbour_checks.py', wdir='D:/HadISD_v3/project')
"""
Analysis & Plotting
...
"""
#run qc_summary.py
runfile('D:/HadISD_v3/project/qc_summary.py', wdir='D:/HadISD_v3/project')
#run plot_fail_rate_map.py
runfile('D:/HadISD_v3/project/plot_fail_rate_map.py', wdir='D:/HadISD_v3/project')
#run calculate_humidity_and_indices.py
runfile('D:/HadISD_v3/project/calculate_humidity_and_indices.py', wdir='D:/HadISD_v3/project')